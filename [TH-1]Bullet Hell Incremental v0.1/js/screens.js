class screens {
    ...
    showScreen(screenId) {
        ...
        switch(screenId) {
            ...
            case 'character-screen':
                this.core.characters.updateCharacterUI();
                break;
        }
    }
    ...
    initEventListeners() {
        ...
        document.getElementById('character-btn').addEventListener('click', () => this.showScreen('character-screen'));
        document.getElementById('upgrade-btn').addEventListener('click', () => this.showScreen('upgrade-screen'));
        ...
        document.getElementById('back-to-main5').addEventListener('click', () => this.showScreen('main-menu'));
